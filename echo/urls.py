...
from echo.views import SMSCampaign, SMSHistory, MailCampaign, MailHistory, SMSBundle, MailBundle
...
urlpatterns = patterns(
    ...
    url(r'^mail/$', permission_required('echo.ik_messaging_campaign')(MailHistory.as_view()), name='mail_history'),
    url(r'^mail/$', permission_required('echo.ik_messaging_campaign')(MailBundle.as_view()), name='mail_bundle'),
)
